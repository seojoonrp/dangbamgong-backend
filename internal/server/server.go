...
func NewServer() *http.Server {
	...
	authSvc := service.NewAuthService(userRepo, activityRepo, friendshipRepo, friendRequestRepo, voidSessionRepo, blockRepo, deviceTokenRepo, notifRepo, socialVerifier)
